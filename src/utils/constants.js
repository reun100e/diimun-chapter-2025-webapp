...
export const ASSETS = {
  ...
  greatAssemblyImage: '/images/The Great Homoeopathic Assembly.webp',
  ipcImage: '/images/IPC.webp',
  upiQrcode: '/images/upi-qrcode.webp'
}
...
export const STALWARTS = [
  {
    ...
    image: '/images/Bönninghausen.webp'
  },
  {
    name: 'Kent',
    period: '1849-1916',
    contribution: 'Master of constitutional prescribing and philosophy',
    image: '/images/James_Tyler_Kent.webp'
  },
  {
    name: 'Hering',
    period: '1800-1880',
...
export const FOOTER_LINKS = {
  ...
  committeeGuidelines: [
    { href: '/who-committee-guidelines', label: 'WHO Committee Guidelines' },
    { href: '/great-assembly-guidelines', label: 'Great Assembly Guidelines' },
    { href: '/ipc-guidelines', label: 'IPC Guidelines' }
  ],
  support: [
    { href: '/terms', label: 'Terms & Conditions' },
    { href: '/technology-policy', label: 'Technology Policy' },
...
export const BENEFITS = [
  {
    ...
    image: '/images/First-Person Role Playing.webp',
  ...
  },
  {
    ...
    image: '/images/Shape the Event Flow.webp',
  ...
  },
  {
    ...
    image: '/images/Voice Your Opinions.webp',
  ...
  },
  {
    ...
    image: '/images/Unearth Hidden Philosophies.webp',
  ...
  },
  {
    ...
    image: '/images/Free Communication Workshop.webp',
